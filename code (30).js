...
class SessionManager {
    ...
    updateCurrentSessionInfo() {
        ...
        if (this.currentSessionId && this.sessions[this.currentSessionId]?.name) {
            ...
            // console.log(`SessionManager: Session active: "${currentName}"`); // Moins verbeux
        } else {
             // console.log(`SessionManager: Aucune session active.`); // Moins verbeux
    ...
    loadAllSessions() {
        // console.log("SessionManager: loadAllSessions."); // Moins verbeux
        try {
    ...
    saveAllSessions() {
        // console.log("SessionManager: saveAllSessions."); // Moins verbeux
